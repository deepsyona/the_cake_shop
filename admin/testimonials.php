...
<head>
    ...
    <title>The Cake Shop | Manage testimonials</title>
                            ...
                            <div class="panel-body">
                                ...
                                <table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT
  users.name,
  pato_testimonial.UserEmail,
  pato_testimonial.Testimonial,
  pato_testimonial.PostingDate,
  pato_testimonial.STATUS,
  pato_testimonial.id 
FROM
  pato_testimonial
  JOIN users ON users.email = pato_testimonial.UserEmail
  ";
                                        $query = $dbh->prepare($sql);
                                        $query->execute();
