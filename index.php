      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Sweeten your day with our delicious Cakes!</h1>
            <p>We bring you the most delicious cakes. The only thing you have to do is to enjoy them. </p>
...
<span class="price">Rs<?php echo htmlentities($row['productPrice']);?> <s>  Rs <?php echo htmlentities($row['productPriceBeforeDiscount']);?></s></span>
